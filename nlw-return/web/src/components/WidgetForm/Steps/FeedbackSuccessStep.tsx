...
export function FeedbackSuccessStep({ resetFeedback }: FeedbackSuccessStepProps) {
  return (
    <>
      <header>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <h1 className="mt-2 mb-6 font-medium text-xl">Agradecemos o feedback!</h1>
        <button
          type="button"
          onClick={resetFeedback}
          className="bg-zinc-800 px-6 py-2 rounded hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
